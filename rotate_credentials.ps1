...
Write-Host "WARNING: YOUR CREDENTIALS WERE EXPOSED ON GITHUB!" -ForegroundColor Yellow
...
Write-Host "      f. COPY the new password (you will need it below)" -ForegroundColor White
...
# Get Gmail address
$smtpUser = Read-Host "   Enter your Gmail address (example your-email@gmail.com)"
Write-Host ""
...
Write-Host "   MongoDB cluster URL (example cluster0.sufzx.mongodb.net):" -ForegroundColor Yellow
$mongoCluster = Read-Host "   "
Write-Host ""

# Build MongoDB URI - properly escape ampersands
...
Write-Host "   4. Verify old credentials do not work anymore" -ForegroundColor White
Write-Host ""
