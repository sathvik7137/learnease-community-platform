...
class _AdminLoginScreenState extends State<AdminLoginScreen> with TickerProviderStateMixin {
  ...
  Color _getBackgroundGradientStart() {
    return _isDarkMode 
        ? const Color(0xFF0D1117) // Charcoal dark
        : const Color(0xFFEEF2FF); // Pale lavender
  }

  Color _getBackgroundGradientEnd() {
    return _isDarkMode 
        ? const Color(0xFF1B1F29) // Midnight blue
        : const Color(0xFFF8FAFC); // Soft gray-white
  }
  ...
  Color _getPrimaryTextColor() {
    return _isDarkMode 
        ? const Color(0xFFE5E7EB) // Off-white
        : const Color(0xFF111827); // Dark gray
  }

  Color _getSecondaryTextColor() {
    return _isDarkMode 
        ? const Color(0xFF9CA3AF) // Medium gray
        : const Color(0xFF6B7280); // Gray
  }

  Color _getInputBackground() {
    return _isDarkMode 
        ? const Color(0xFF1F2937).withOpacity(0.8) // Translucent blue-gray
        : Colors.white.withOpacity(0.9); // White with 10% transparency
  }
  ...
  Color _getGlowColor({bool isActive = true}) {
    if (!isActive) return _isDarkMode ? const Color(0xFF374151) : const Color(0xFFE5E7EB);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: FadeTransition(
        ...
        child: Stack(
          children: [
            // Adaptive gradient background with smooth theme transition
            AnimatedContainer(
              duration: const Duration(milliseconds: 400),
                ...
                gradient: LinearGradient(
                  ...
                  colors: isDark
                      ? [
                          ...
                          const Color(0xFF161B22), // Dark slate
                          const Color(0xFF1B1F29), // Dark indigo
                        ]
                      : [
                          const Color(0xFFEEF2FF), // Pale lavender
